...
Everything is in **one Python file**. 

Install Stable Diffusion and install [streamlit](https://docs.streamlit.io/library/get-started/installation) and [joblib](https://joblib.readthedocs.io/en/latest/installing.html). Run:

```bash
streamlit run scripts/st_txt2img.py -- --cuda
```

That's it. 

![demo](assets/streamlit_ui/demo.gif)
